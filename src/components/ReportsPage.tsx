...
export function ReportsPage({ controller }: { controller: WorkspaceController }) {
  ...
  return (
    <div className="page reports-page">
      ...
      {uploading ? <div role="status">正在保存音频…</div> : null}{actionError ? <div className="action-notice" role="status">{actionError}</div> : null}
